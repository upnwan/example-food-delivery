...
1. 트랜잭션
    1. 내용 업데이트 필요
1. 장애격리
    1. 내용 업데이트 필요  Async (event-driven), Eventual Consistency
    1. 내용 업데이트 필요  Circuit breaker, fallback
1. 성능
...
### 부적격 이벤트 탈락
![image](https://user-images.githubusercontent.com/70302884/96573213-c58dc200-1308-11eb-8395-dcfd777d90fc.png)
